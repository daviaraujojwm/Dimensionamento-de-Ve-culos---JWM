...
lista_veiculos = [
    ...
    {"nome": "(HR Aberto)", "largura": 1.800, "status": "Caminhonete Abreta", "comprimento": 3.000, "altura": 2.000, "peso_max": 1300},
    ...
    {"nome": "Carreta Movida a GNV", "largura": 2.400, "comprimento": 12.000, "altura": 2.700, "peso_max": 24000},
    ...
    {"nome": "Bitruck Slider", "largura": 2.400, "comprimento": 10.000, "altura": 2.700, "peso_max": 18000},
    ...
    if not st.session_state.cargas:
        ...
        for veiculo in veiculos_para_olhar:
            ...
            if (volume_total_cargas <= limite_volume) and (peso_total_cargas <= veiculo["peso_max"]):
                ...
                # viabilidade sempre entre 0% e 100%
                viabilidade = min(100, round((aproveitamento_vol * aproveitamento_peso) * 100, 2))
                ...
                veiculos_viaveis.append({
                    ...
                    "Parâmetros": f'{veiculo["comprimento"]}m x {veiculo["largura"]}m x {veiculo["altura"]}m | {veiculo["peso_max"]}kg',
